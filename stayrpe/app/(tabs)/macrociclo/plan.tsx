...
const PlanMacrocycleScreen = () => {
  ...
  // Datos del macrociclo desde los parámetros
    ...
    try {
      ...
      if (response.ok) {
        Alert.alert(
          ...
          [{ text: 'OK', onPress: () => router.push('/(tabs)/macrociclo') }]
        );
      } else {
      ...
      >
        ...
        <View style={styles.summaryCard}>
          ...
          <Text style={styles.summaryText}>
            {macrocycleData.microcycleDurationDays} días • {macrocycleData.totalMicrocycles} repeticiones
          </Text>
        </View>
